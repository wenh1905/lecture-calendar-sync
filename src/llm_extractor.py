...
输出要求：
- 所有字段内容必须使用中文（title 保留英文原文）
- speaker 格式为"姓名 工作单位"，中间用空格隔开，如"刘开辉 北京大学"、"肖云峰 北京大学"、"游建强 浙江大学"。如果是清华大学本校教师也需注明，如"张三 清华大学"
- location 格式固定为"学校/楼/房间号"，如果是清华大学则省略学校名。示例：
  - 清华大学物理楼 W101 → 物理楼/W101
  - 北京大学物理楼中212会议室 → 北京大学/物理楼/212
  - Physics Building E100 → 物理楼/E100
  - Conference Hall 322, Science Building → 科学馆/322
  - 物理楼（附中南侧）W101 → 物理楼/W101
  注意：Physics Building、物理楼（附中南侧）等写法统一简写为"物理楼"
- summary 字段请用约100字中文概括讲座核心内容

请严格以如下 JSON 格式输出，不要输出任何其他内容：
{"title": "讲座标题", "start_time": "YYYY-MM-DD HH:MM", "end_time": "YYYY-MM-DD HH:MM", "location": "地点", "speaker": "主讲人", "summary": "约100字中文内容概括", "is_relevant": true/false}
